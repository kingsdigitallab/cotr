...
ALLOWED_HOSTS = env.list("VIRTUAL_HOST", default=["ctrs2.cch.kcl.ac.uk"])
...
# CACHES
# https://docs.djangoproject.com/en/2.2/topics/cache/#local-memory-caching-1
# GN: KISS, disabled redis, not needed for small site with low traffic.
# ------------------------------------------------------------------------------
# CACHES = {
#     "default": {
